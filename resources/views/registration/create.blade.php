...
<div style=" background-color:#fff; padding:0px; width:100%;float: right;margin-top: 10px;">
	...
	<div class="content-gf">
        ...
        <form class="new_user" id="new_user" action="/dangky" accept-charset="UTF-8" method="post">
        {{ csrf_field() }}
		...
		<table>
			<tr>
				...
				<td>
					<input class="required" type="text" name="user[fullname]" id="user_fullname" /><br>
			...
			<tr>
				<td>Email<sup>*</sup></td>
				<td>
					<input class="required" type="text" name="user[email]" id="user_email" /><br>
			...
			<tr>
				...
				<td>
					<input class="required" type="password" name="user[password]" id="user_password" /><br>
			...
			<tr>
				...
				<td>
					<input class="required equalTo(&#39;#user_password&#39;)" type="password" name="user[password_confirmation]" id="user_password_confirmation" /><br>
...
<style>.select-location{width:312px;padding:5px 0}</style>
@endsection
