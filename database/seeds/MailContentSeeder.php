...
class MailContentSeeder extends Seeder
{
    ...
    {
         $form_data = array(
            'content' =>   "<p><strong>Linhkieniotvn</strong> &nbsp;xin ch&acirc;n th&agrave;nh cảm ơn Qu&yacute; kh&aacute;ch €&atilde; lựa chọn sản phẩm của ch&uacute;ng t&ocirc;i.<br />
...
C&uacute; ph&aacute;p thanh to&aacute;n:&nbsp;<strong>Họ T&ecirc;n_M&atilde; €ơn h&agrave;ng_Ng&agrave;y €ặt h&agrave;ng.</strong><br />
&nbsp;</p>",
